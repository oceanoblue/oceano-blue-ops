    ...
    <section id="work" className="bg-ink py-20 text-paper sm:py-28">
      <div className="container-edge">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between" data-reveal>
          ...
          <Link href="/work" data-cursor className="btn-outline border-paper/40 text-paper hover:bg-paper hover:text-ink">
        ...
        <div className="mt-14 space-y-4 sm:space-y-5">
          <div className="grid grid-cols-1 gap-4 sm:gap-5 md:grid-cols-12">
            <Tile p={PROJECTS[0]} className="md:col-span-8" aspect="aspect-[16/10]" />
            <Tile p={PROJECTS[1]} className="md:col-span-4 md:aspect-auto md:h-full" aspect="aspect-[4/5]" />
          </div>
          <div className="grid grid-cols-1 gap-4 sm:gap-5 md:grid-cols-12">
            <Tile p={PROJECTS[2]} className="md:col-span-4 md:aspect-auto md:h-full" aspect="aspect-[4/5]" />
            <Tile p={PROJECTS[3]} className="md:col-span-8" aspect="aspect-[16/10]" />
          </div>
          <div className="grid grid-cols-1 gap-4 sm:gap-5 md:grid-cols-2">
            <Tile p={PROJECTS[4]} aspect="aspect-[4/3]" />
            <Tile p={PROJECTS[5]} aspect="aspect-[4/3]" />
          </div>
        </div>
      </div>
    </section>
