...
export function AssignShooterControl({
  ...
  return (
    <div>
      ...
      <p className="text-xs text-slate-600">Each person reserves only their visit. Times are {timezone.replaceAll('_',' ')} and must fit within the client appointment. Shortening an accepted visit keeps its confirmation when the arrival time and photographer stay the same. Changing arrival or extending the visit requires a new response. Office-assigned photographers have 24 hours to respond, or until the shoot starts if sooner.</p>
