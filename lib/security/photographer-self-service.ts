...
export function photographerSelfServicePath(pathname: string) {
  return ['/api/scheduling/hours','/api/scheduling/time-off','/api/scheduling/respond','/api/auth/google/connect','/api/auth/google/callback','/api/auth/google/disconnect'].includes(pathname);
}
